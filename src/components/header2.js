...
function Header2({ handleScrollToFrequencyQuestion, handleScrollToPresale, handleScrollToTokenomics, handleScrollToDapp, handleScrollToRoadmap }) {
  ...
  //     window.scrollTo(0, 200); // Scroll down by 1 pixel
  //     window.scrollTo(0, 0); // Scroll back to the top

  //     console.log("jell2");
  //     // Add your onscroll function
  //     window.onscroll = () => {
  ...
  return (
    <>
      ...
      {/* {musicOverlay && <div className="overlay-music" onMouseMove={handleMusicHover}></div>} */}
        ...
        <div className="header-wrap" style={{ backgroundColor: 'transparent' }}>
          ...
          <div className="left">
            ...
            >
              <img
                src={logo}
                alt=""
                style={{ width: '87px', borderRadius: '0%', position: 'absolute', top: '0' }}
              />
            </div>
          </div>
          <div className="center" style={{ marginTop: "-3px" }}>
            <ul style={{ dispaly: 'flex', gap: '50px' }}>
              ...
              <li>
                <a className="red-glow" href={whitePaperPDF} target="_blank" rel="noopener noreferrer">Whitepaper</a>
              </li>
            </ul>
          </div>
          <div className="right" style={{ marginTop: "10px" }}>
            <ul>
              <li>
                <a href="https://t.me/memenator" previewlistener="true">
        ...
        <SciFiUI>
          <Ul isMobileMenuOpen={isMobileMenuOpen}>
            ...
            <li style={{
              ...
              <button id="muteButton">
                {musicStatus ? <img src={musicIcon} className="my-button u-btn" onClick={handleMusicButton}></img> : <img src={musicStopIcon} className="u-btn" onClick={handleMusicButton}></img>}
              </button>
            </li>
          </Ul>
        </SciFiUI>
