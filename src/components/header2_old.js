          ...
          <div className="left">
            ...
            >
              <img
                src={logo}
                alt=""
                style={{ width: '87px', borderRadius: '100%', position: 'absolute', top: '0' }}
              />
            </div>
          </div>
          <div className="center" style={{ marginTop: "0px" }}>
        ...
        <SciFiUI>
          <Ul isMobileMenuOpen={isMobileMenuOpen}>
            ...
            <li style={{
              ...
              <button id="muteButton">
                {musicStatus ? <img src={musicIcon} style={{ width: "50px", height: "40px" }} onClick={handleMusicButton}></img> : <img src={musicStopIcon} className="u-btn" onClick={handleMusicButton}></img>}
              </button>
            </li>
          </Ul>
        </SciFiUI>
