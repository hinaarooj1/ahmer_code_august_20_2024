...
import footerVideo from "../assets/new_image/footer_video.mp4";
import r100 from "../assets/logo/r1000logo.png"
...
const Footer = () => {
  ...
  return (
    <footer className="footer bg-fade">
      ...
      <div className="top-row">
        <div className="youtube-videos">
          ...
          {/* <div className="videos " style={{ marginTop: '20px' }}>
            <div style={{ marginBottom: '20px' }}>
              <ReactPlayer
                url="https://vimeo.com/932219856"
      ...
      <div className="middle-row">
        <div className="column useful-links">
          ...
          <ul>
            ...
            <li><a href="#dashboard">R1000 DApp</a></li>
        ...
        <div className="column image-container landing-video-container colm">
