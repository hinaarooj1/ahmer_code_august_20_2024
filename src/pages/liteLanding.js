...
import bgVideo from "../assets/images/newtl.png";
// import bgVideo from "../assets/images/NewTL2.mp4";
import bgVideoMobile from "../assets/images/mobile.png";
...
import faqVideo from "../assets/images/faq2.png";
      ...
      <div className="home" >
        ...
        <div className="home-wrap">
          ...
          <section ref={sectionRef} className="video-banner">
            ...
            <div className="home-sec-1 mt-5 desktop-video lite-vif">
              {/* <video className="this-vid" src={bgVideo} autoPlay loop muted></video> */}
              {/* <img src={bgVideo} alt="" /> */}
            </div>
            <div className="home-sec-1 mt-5 mobile-video lite-vif2">
          ...
          <section ref={DappRef} className="main-nsh main-ss" id="dapp-section">
            <div className="home-sec-3 dapp-lite  ">
          ...
          <section ref={faqRef} id="faq" className="faq-scroll-soft background-vff" style={{ scrollSnapType: "y proximity" }} >
          ...
          <section className="faq-scroll-soft liter" style={{ scrollSnapType: "y proximity" }}>
