...
function Landing() {
  ...
  function adjustHeight() {
    ...
    if (videoElement) {
      ...
      const excessHeight = videoHeight - adjustedHeight;
      ...
      <div className="home" >
        ...
        <div className="home-wrap">
          ...
          <section ref={sectionRef} className="video-banner">
            ...
            <div className="home-sec-1 mt-5 desktop-video">
              <video className="this-vid" src={bgVideo} autoPlay loop muted></video>
            </div>
                    ...
                    <div style={{ marginBottom: "30px" }}>
                      ...
                      <div className="main-con" style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", marginTop: "30px", gap: "30px" }}>
                        {solAmount < ROUND_CAP ? <div style={{ marginLeft: "5px", marginRight: " 5px" }}>
                          <p style={{ textAlign: "center", fontFamily: "Technology-Bold" }} className="upper-heading-coins standard-spacing">0.(5)1 SOL/coin</p>
                          <button className="gradient-border-circle crosshair crosshair-8" style={{ textWrap: "wrap" }}>Round 1</button>
                          ...
                          <div style={{ display: "grid", alignItems: "center", marginLeft: " 5px", marginRight: " 5px" }}>
                            <p style={{ textAlign: "center", fontFamily: "Technology-Bold" }} className="upper-heading-coins standard-spacing standard-spacing">0.(5)1 SOL/coin</p>
                  ...
                  <div className="row roadmap">
                    ...
                    <div className="carousel-new">
                      ...
                      <div className="carousel-rotation-direction">
                        <ul className="carousel-item-wrapper"  >
                          <li className="carousel-item-new carousel-1 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-2 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-3 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-4 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-5 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-6 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-7 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-8 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-9 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-10 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                          <li className="carousel-item-new carousel-11 carousel-img" >
                            <a href="https://unsplash.com/de/fotos/ein-hohes-gebaude-mit-einer-uhr-an-der-seite-cI09n4yMIYc" target="_blank"></a></li>
                    ...
                    <div className="faq-section w-50">
                      <ul className="faq-list">
                        ...
                        <li className="faq-item">
                          ...
                          >
                            <div class="answer" style={{ fontFamily: "termin-font", fontSize: "13px", letterSpacing: "5px" }}>
                              {" "}
